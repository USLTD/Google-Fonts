    ...
    $manifest = [ordered]@{
        ...
        uninstaller  = @{
            script = @(
                ...
                "            Write-Host `"Warning: Could not remove registry entry for `$fontName: `$_`" -ForegroundColor Yellow",
                "            `$failedRemovals += `$file",
                "        }",
                "    }",
                "    ",
                ...
                "        }",
                "    } catch {",
                "        Write-Host `"Warning: Could not remove font file `$file: `$_`" -ForegroundColor Yellow",
                "        `$failedRemovals += `$file",
                "    }",
                "}",
                "",
